...
export default function RegisterPage() {
  ...
  const handleWorkspaceChange = (val: string) => {
    ...
    setError("");
    if (val.length > 2) {
      setWorkspaceValid(val.replace(/\s+/g, "").length >= 3);
    } else {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      alert("Workspace Created Successfully! Redirecting to login...");
      router.push("/login");
    } catch {
        ...
        <div className="erp-left">
          ...
          <div className="fcards">
            <div className="fcard fc1">
              <div className="fcard-lbl">Tenant Scale</div>
              <div className="fcard-val">14+</div>
              <div className="fcard-sub up">Active Branch Clusters</div>
            </div>
            <div className="fcard fc2">
              <div className="fcard-lbl">Setup Time</div>
              <div className="fcard-val">&lt; 2m</div>
              <div className="fcard-sub up">Instant Deployment</div>
            </div>
            <div className="fcard fc3">
              <div className="fcard-lbl">Database Nodes</div>
              <div className="fcard-val">Multi</div>
              <div className="fcard-sub" style={{color:'rgba(255,255,255,.4)'}}>Postgres+Redis Sync</div>
            </div>
            <div className="fcard fc4">
              <div className="fcard-lbl">Data Security</div>
              <div className="fcard-val">AES-256</div>
              <div className="fcard-sub up">Enterprise Guarded</div>
            </div>
          </div>
          ...
          <div className="left-copy">
            <div className="left-tag">Tenant Onboarding Wizard</div>
            <h1>Scale your entire<br/>business with <em>AI</em></h1>
            <p>Deploy a dedicated, secure Next-Gen Enterprise Resource Planning environment for your firm in seconds.</p>
            <div className="pills">
        ...
        <div className="erp-right">
          ...
          {mounted && (
            <div className="form-wrap fade-up">
              ...
              <div className="divider"><span>or setup workspace with email</span></div>
              ...
              <div className="field">
                <label>Company / Tenant Workspace Name</label>
                <div className="input-wrap">
                  ...
                  <input
                    ...
                    className={`erp-input ${workspaceValid === true ? 'valid' : workspaceValid === false ? 'invalid' : ''}`}
                  />
                  {workspaceValid !== null && (
